...
export const attractionApi = {
  query: async (params: { id?: number, page?: number, pageSize?: number, keyword?: string }) => {
  ...
  add: async (attractionData: { name: string, description: string, open_time: string, image_url: string }) => {
...
export const feedbackApi = {
  add: async (feedbackData: { attraction_id: number, score: number, comment?: string }) => {
  ...
  stats: async (params: { attraction_id?: number, include_deleted?: boolean }) => {
...
export const adminApi = {
  ...
  getLogs: async (params: { page?: number, pageSize?: number, startDate?: string, endDate?: string }) => {
